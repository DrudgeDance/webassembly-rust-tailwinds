...
pub fn get_theme() -> ComponentTheme<HelloColors> {
    ComponentTheme {
        ...
        colors: HelloColors {
            ...
            focus_ring: "orange-600".to_string(),
            active_background: "orange-600".to_string(),
            active_border: "orange-500".to_string(),
            heading_text: "orange-100".to_string(),
        },
    }
} 